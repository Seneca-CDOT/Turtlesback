 ...
 *
 */
static class ScreenGroundedUtils {
   ...
   */
  static float[] getTimeValues(float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4, int frames) {
    ...
    float len[] = new float[frames];
    float trp[] = new float[frames];
    int frame = 1;
